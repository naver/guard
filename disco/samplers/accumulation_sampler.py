...
class AccumulationSampler(Sampler):
    ...
    def sample(self, sampling_size=32, context="", qa_concat=False):
        ...
        with trange(
            ...
            while remaining > 0:
                more_samples, more_log_scores = self.distribution.sample(context=context, sampling_size=sampling_size, qa_concat=qa_concat)
